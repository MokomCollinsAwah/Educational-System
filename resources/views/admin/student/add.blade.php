                        ...
                        <form method="post" action="">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="date" class="form-control" value="{{old('date_of_birth')}}" name='date_of_birth' required placeholder="DOB">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="">Parent/Guadian Phone Number</label>
                                    <input type="text" class="form-control" value="{{old('parents_contact')}}" name='parents_contact' required placeholder="phone_number">
                                </div>
